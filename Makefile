...
src		= $(main).c vol.c buttons.c mpd.c mode.c util.c flua_config.c

hdr		= vol.h buttons.h mpd.h mode.h util.h global.h const.h flua_config.h

obj		= $(main).o vol.o buttons.o mpd.o mode.o util.o flua_config.o
